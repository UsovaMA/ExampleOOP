 ...
 *    -> путь до Desk.h
 *
 * О текущей версии проекта:
 *   1. Создан шаблон проекта с визуальной частью (App) и статической библиотекой Desk,
 *   2. Подготовлен набросок визуального интерфейса,
 *   3. Создан ассортимент для тестов,
 *   4. Проработано открытие "окна" сканирвоания.
 */
